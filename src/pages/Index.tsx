  ...
  return (
    <div
      ...
      style={{
        ...
        height: 140,
        borderRadius: 12,
        border: `1.5px solid ${hovered ? "#c0392b" : "#e8c0bb"}`,
        background: hovered ? "#fff3f1" : "#fff",
        boxShadow: hovered ? "0 10px 32px rgba(192,57,43,0.2)" : "0 2px 8px rgba(192,57,43,0.07)",
